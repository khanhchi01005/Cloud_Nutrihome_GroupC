...
import { FiCpu, FiCalendar, FiClock, FiUsers, FiCamera, FiMessageCircle } from "react-icons/fi";
...
export default function HomePage() {
    ...
    console.log(meals);
    const features = [
        { name: "Thực đơn hàng tuần", icon: _jsx(FiCalendar, {}), href: "/weekly_menu" },
        { name: "Tạo Thực đơn hàng tuần", icon: _jsx(FiCpu, {}), href: "/create_weekly_menu" },
        { name: "Món ăn", icon: _jsx(GiKnifeFork, {}), href: "/recipes" },
        { name: "Lịch sử ăn uống", icon: _jsx(FiClock, {}), href: "/history" },
        { name: "Gia đình", icon: _jsx(FiUsers, {}), href: "/family" },
        { name: "Quét nguyên liệu", icon: _jsx(FiCamera, {}), href: "/ingredient_safety" },
        { name: "Cộng đồng", icon: _jsx(FiMessageCircle, {}), href: "/community" },
    ];
    const articles = [
        {
    ...
    return (_jsxs("div", { className: "pt-27 container mx-auto px-4 mb-10 space-y-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-[30%_70%] gap-4", children: [_jsx("div", { className: "bg-white rounded-xl shadow-md p-4 h-96", children: _jsx(NutritionOverview, { data: nutritionData }) }), _jsx("div", { className: "bg-white rounded-xl shadow-md p-4 h-96", children: _jsx(NextMeal, { meals: meals }) })] }), _jsx(FeatureButtons, { features: features }), _jsx(HotFoods, { foods: hotFoods }), _jsx(LatestArticles, { articles: articles })] }));
}
