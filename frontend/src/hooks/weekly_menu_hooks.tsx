...
export function useWeeklyMenu() {
    ...
    const fetchWeeklyMenu = useCallback(async () => {
        ...
        try {
            const response: WeeklyMenu = await apiGet("/api/weekly_menu/get_weekly_menu", {
                user_id,
            });
...
export function useMealByDayAndType() {
    ...
    const [meals, setMeals] = useState<WeeklyMenu["menu"]["mon"]["breakfast"]["items"]>([]);
    ...
    const getDayKey = (date: Date): keyof WeeklyMenu["menu"] => {
        return date.toLocaleDateString("en-US", { weekday: "short" }).toLowerCase() as keyof WeeklyMenu["menu"];
    };
...
export function useAddCustomMeal() {
    ...
    const addCustomMeal = async (user_id: number, name: string, day: string, meal: string) => {
        setLoading(true);
        setError(null);
...
export function useRemoveCustomMeal() {
    ...
    const removeCustomMeal = async (user_id: number, name: string, day: string, meal: string) => {
        setLoading(true);
        setError(null);
...
export function useUploadReceipt() {
    ...
    const uploadReceipt = async (user_id: number, image_path: string, day: string, meal: string) => {
        setLoading(true);
        setError(null);
